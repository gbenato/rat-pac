...
ch_bottom = out_dir + 'results/TheiaRnD_TeO2_comiscs_1/PMT_out.root'
ch_sides = out_dir + 'results/TheiaRnD_TeO2_comiscs_2/PMT_out.root'
scint_sides = out_dir + 'results/TheiaRnD_TeO2_comiscs_scint_2/PMT_out.root'
scint_bottom = out_dir + 'results/TheiaRnD_TeO2_comiscs_scint_1/PMT_out.root'
ch_rough_bottom = out_dir + 'TheiaRnD_TeO2_rough_comiscs_1/PMT_out.root'
...
for idx in range(t1.GetEntries()):
  ...
  h_sum_rough.Fill((t5.pmt3+t5.pmt2+t5.pmt1))
