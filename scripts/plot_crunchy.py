...
ch_bottom = out_dir + 'results/TheiaRnD_TeO2_cosmics_1/PMT_out_v2.root'
ch_sides = out_dir + 'results/TheiaRnD_TeO2_cosmics_2/PMT_out_v2.root'
scint_sides = out_dir + 'results/TheiaRnD_TeO2_cosmics_scint_2/PMT_out_v2.root'
scint_bottom = out_dir + 'results/TheiaRnD_TeO2_cosmics_scint_1/PMT_out_v2.root'
ch_rough_bottom = out_dir + 'TheiaRnD_TeO2_rough_cosmics_1/PMT_out_v2.root'
scint_rough_bottom = out_dir + 'TheiaRnD_TeO2_rough_cosmics_scint_1/PMT_out_v2.root'
ch_noTeO2 = out_dir+'results/TheiaRnD_noTeO2_cosmics_1/PMT_out_v2.root'
...
t6=f6.Get("t")
f7 = ROOT.TFile(scint_rough_bottom)
t7=f7.Get("t")
...
t4.Draw("pmt3/pmt1>>h3(100,0,1)","", "same")
(ROOT.gPad.GetListOfPrimitives().At(1)).SetLineColor(ROOT.kRed)
c1.cd(3)
...
h_sum_scint = ROOT.TH1F("h_pe_scint","Sum of detected PEs (scintillation + Ch) with acrylic on bottom", 100, 0,10000 )
...
my_range = min([t1.GetEntries(), t2.GetEntries(), t3.GetEntries(), t4.GetEntries(), t5.GetEntries(), t6.GetEntries(), t7.GetEntries()])
sim_evts=35
for idx in range(my_range):
  ...
  if t7.evts_started:
    ...
    print idx, 't7 without any muons started', t7, t7.pmt3
...
h_sum_rough_scint.SetLineColor(ROOT.kPink+10)
