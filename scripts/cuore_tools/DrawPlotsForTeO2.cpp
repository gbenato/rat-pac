...
int main(int argc, char **argv){
  ...
  TH1F* h_e_length = new TH1F("h_e_length","h_e_length",300,0,20); //e- flight path 
  ...
  TH2F* h_e_lengthvsnph = new TH2F("h_e_lengthvsnph","h_e_lengthvsnph",200,0,2000,300,0,20);
  TH2F* h_e_energyvsnph = new TH2F("h_e_energyvsnph","h_e_energyvsnph",200,0,2000,300,0,5);
  TH2F* h_e_lengthvsnpe = new TH2F("h_e_lengthvsnpe","h_e_lengthvsnpe",50,0,400,300,0,20);
  TH2F* h_e_lengthvsq = new TH2F("h_e_lengthvsq","h_e_lengthvsq",150,0,100,300,0,20);
